...
public class SyncConstants {
    public static final String ACCOUNT_TYPE = "com.example.priyasindkar.syncClasses";
    public static final String ACCOUNT_NAME = "Simple Sync Adapter";
    public static final String USERDATA_USER_OBJ_ID = "userObjectId";   //Parse.com object id
    public static final String AUTHORITY = "com.example.priyasindkar.syncadapterdemo";
